  ...
  return (
      ...
      <div className="boxContainer">
        <div className="box1">
          ...
          <p>
            ...
            remarkable customer support. A podcast series usually features 
            one or more recurring hosts engaged in a discussion about a 
    ...
    {/* 2ND */}
      <div className="Container">
          <div className="BoxContainer">
                    <h1> Best Podcast Talk Website</h1>
                    <div className="podbtn">Free & Paid</div>
          </div>
        </div>
